...
var VirtualKeyboard = new function () {
    var I = this;
    I.$VERSION$ = "3.7.1.788";
    var l = findPath('js/vk_loader.js');  //修改js引用路径
    var o = /\x03/;
    var O = {
        'layout': null,
        'skin': 'winxp'
        ...
        switch (i.type) {
            case 'keydown':
                switch (iI) {
                    ...
                    default:
                        if (!i.getRepeat()) {
                            //CHANGE1,清除ctrl/alt单独效果以及叠加效果
                            // e = e | i.shiftKey | i.ctrlKey << 2 | i.altKey << 1
                            e = e | i.shiftKey
                            //CHANGE1
                        }
                        //CHANGE2，清除ctrl/alt单独效果以及叠加效果
    ...
    var A = function (i) {
        ...
        //CHANGE5，清除ctrl/alt单独效果以及叠加效果
        // var iI = X & (s | i.shiftKey | i.altKey << 1 | i.ctrlKey << 2);
        var iI = X & (s | i.shiftKey);
        //CHANGE5
        if (X != iI) {
            B(iI);
            b();
    ...
    var h = function (i) {
        if (i) {
            ...
            // var e = DOM.StyleSheet(l + 'css/' + 'keyboard.css');
            var e = DOM.StyleSheet('css/' + 'keyboard.css');
            e.add();
        }
        var iI = DOM.getWindow(U.attachedInput);
        if (window != iI) {
            // var e = DOM.StyleSheet(l + 'css/' + O.skin + '/keyboard.css', iI);
            // var e = DOM.StyleSheet(l + 'css/' + 'keyboard.css', iI);
            var e = DOM.StyleSheet('css/' + 'keyboard.css',iI);
            if (i) {
                e.add();
            } else {
                e.remove();
    ...
    (function () {
        ...
        var iv = getScriptQuery('js/vk_loader.js'),   //修改js引用路径
...
VirtualKeyboard.IME = new function () {
    ...
    i.updatePosition = function () {  //字体显示框位置
        var x = DOM.getOffset(c);
        l.style.left = x.x + parseInt(200) +'px';
    ...
    //CHANGE8,设置延伸字体显示5行
    i.nextPage = function (x) {          //下一页设置
        O = Math.max(Math.min(O + 1, (Math.ceil(_.length / 10)) - 1), 0);
        if( O <= 4 ){e();hidefrom5();}
        if( O <= 9 && O >= 5 ){e();hidefrom10();}
        if( O <= 14 && O >= 10 ){e();hidefrom15();}
        if( O <= 19 && O >= 15 ){e();hidefrom20();}
        if( O <= 24 && O >= 20 ){e();hidefrom25();}
        if( O <= 29 && O >= 25 ){e();hidefrom30();}
        if( O <= 34 && O >= 30 ){e();hidefrom35();}
        if( O <= 39 && O >= 35 ){e();hidefrom40();}
        if( O <= 44 && O >= 40 ){e();hidefrom45();}
        if( O <= 49 && O >= 45 ){e();hidefrom50();}
    };
    //CHANGE8,设置延伸字体显示5行
    i.prevPage = function (x) {          //上一页设置
        O = Math.max(O - 1, 0);
        if( O <= 4 ){e();hidefrom5();}
        if( O <= 9 && O >= 5 ){e();hidefrom10();}
        if( O <= 14 && O >= 10 ){e();hidefrom15();}
    ...
    var e = function () {
        ...
        x.push('</table>');
        l.firstChild.rows[0].cells[1].innerHTML = x.join("");   //添加汉字
        l.firstChild.rows[1].cells[0].firstChild.firstChild.innerHTML = (O + 1) + "/" + (0 + Q || Math.ceil(_.length / 10));  //计算页码
    ...
    //CHANGE8,设置延伸字体显示5行
    var hidefrom5 = function(){
        var content1=$('.IMEControl table tr:nth-child(5)');   //除1-5行，其他行数隐藏
        content1.nextAll('tr').hide();
    }
    var hidefrom10 = function(){
        var content1=$('.IMEControl table tr:nth-child(10)');   //除6-10行，其他行数隐藏
        content1.nextAll('tr').hide();
        var content2=$('.IMEControl table tr:nth-child(6)');  
        content2.prevAll('tr').hide();
    }
    var hidefrom15 = function(){
        var content1=$('.IMEControl table tr:nth-child(15)');   //除11-15行，其他行数隐藏
        content1.nextAll('tr').hide();
        var content2=$('.IMEControl table tr:nth-child(11)');   
        content2.prevAll('tr').hide();
}
    var hidefrom20 = function(){
        var content1=$('.IMEControl table tr:nth-child(20)');   //除16-20行，其他行数隐藏
        content1.nextAll('tr').hide();
        var content2=$('.IMEControl table tr:nth-child(16)');  
        content2.prevAll('tr').hide();
}
    var hidefrom25 = function(){
        var content1=$('.IMEControl table tr:nth-child(25)');   //除21-25行，其他行数隐藏
        content1.nextAll('tr').hide();
        var content2=$('.IMEControl table tr:nth-child(21)');   
        content2.prevAll('tr').hide();
}
    var hidefrom30 = function(){
        var content1=$('.IMEControl table tr:nth-child(30)');   //除36-30行，其他行数隐藏
        content1.nextAll('tr').hide();
        var content2=$('.IMEControl table tr:nth-child(26)');   
        content2.prevAll('tr').hide();
}
    var hidefrom35 = function(){
        var content1=$('.IMEControl table tr:nth-child(35)');   //除31-35行，其他行数隐藏
        content1.nextAll('tr').hide();
        var content2=$('.IMEControl table tr:nth-child(31)');   
        content2.prevAll('tr').hide();
}
    var hidefrom40 = function(){
        var content1=$('.IMEControl table tr:nth-child(40)');   //除36-40行，其他行数隐藏
        content1.nextAll('tr').hide();
        var content2=$('.IMEControl table tr:nth-child(36)');   
        content2.prevAll('tr').hide();
}
    var hidefrom45 = function(){
        var content1=$('.IMEControl table tr:nth-child(45)');   //除41-45行，其他行数隐藏
        content1.nextAll('tr').hide();
        var content2=$('.IMEControl table tr:nth-child(41)');   
        content2.prevAll('tr').hide();
}
    var hidefrom50 = function(){
        var content1=$('.IMEControl table tr:nth-child(20)');   ///除46-50行，其他行数隐藏
        content1.nextAll('tr').hide();
        var content2=$('.IMEControl table tr:nth-child(6)');   
        content2.prevAll('tr').hide();
}
